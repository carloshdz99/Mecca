        ...
        <div class="container">
          <div class="col-md-12">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#"><img src="..\..\..\mecca\estilos\front\img\logoc.png" class="img-responsive" style="margin-top: -28px; width: 80px; height: 80px "></a>
            </div>
        ...
        <div class="row">
          <div class="banner-info">
            <div class="banner-logo text-center">
              <img src="..\..\..\mecca\estilos\front\img\muticlinicaslogo.png" class="img-responsive" style="width: 450px;">
            </div>
